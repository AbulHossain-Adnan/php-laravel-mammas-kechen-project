       ...
       <div class="col-md-8 m-auto">
         <div class="card   mb-3" >
              ...
              <div class="card-body">
                ...
                <form action="{{route('bread.store')}}" method="post" enctype="multipart/form-data">
  @csrf
    ...
    <div class="form-group">
      ...
      <span class="text-danger">{{$message}}</span>
      @enderror
      <input type="file" class="form-control" id="exampleInputPassword1" placeholder="Enter image" name="image2">
    </div>
    <div class="form-group">
