...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> starlightg{{Auth::user()->name}}</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{url('slider')}}" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('slider.create')}}" class="nav-link">Add slider</a></li>
          <li class="nav-item"><a href="{{route('slider.index')}}" class="nav-link">Sliders list</a></li>
        </ul>
        <a href="{{url('about')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('about.create')}}" class="nav-link">Add about</a></li>
          <li class="nav-item"><a href="{{route('about.index')}}" class="nav-link">About list</a></li>
        </ul>
        <a href="{{url('about')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Bread</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a>
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('bread.create')}}" class="nav-link">Add bread</a></li>
          <li class="nav-item"><a href="{{route('bread.index')}}" class="nav-link">bread list</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('categori.create')}}" class="nav-link">add category</a></li>
          <li class="nav-item"><a href="{{route('categori.index')}}" class="nav-link">category list</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('item.create')}}" class="nav-link">add item</a></li>
          <li class="nav-item"><a href="{{route('item.index')}}" class="nav-link">item list</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('reservation.index')}}" class="nav-link">reservation list</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('contact.create')}}" class="nav-link">contact list</a></li>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{route('logout')}}"onclick="event.preventDefault();document.getElementById('log-form').submit();"><i class="icon ion-power"></i> Sign Out</a></li>
                <li>
